...
from .views import DashboardView, EntryDetailView, EntryListView, EntryUpdateView, EntryCreateView, EntryDeleteView, CategorieListView
...
urlpatterns = [
    ...
    path('liste/', EntryListView.as_view(), name='entry-list'),
    ...
    path('categories/', CategorieListView.as_view(), name='list_categorie'),
